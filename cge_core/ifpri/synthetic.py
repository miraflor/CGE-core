# -*- coding: utf-8 -*-
"""Independently authored redistributable IFPRI-format demonstration economy.

This is not copied or derived from the official IFPRI test dataset.  It exists
so installed users and CI can exercise IFPRI-format calibration, closures,
reporting, and solving without licensed source material.
"""
...
def build_synthetic_ifpri_dataset() -> IfpriDataset:
    ...
    accounts = (
        "A", "C", "CIMP", "CEXP", "LAB", "CAP", "HH", "GOV",
        "S-I", "DSTK", "TAXM", "ROW",
    )
    sets = IfpriSets(
        accounts=accounts,
        activities=("A",), agricultural_activities=(),
        commodities=("C", "CIMP", "CEXP"), agricultural_commodities=(),
        domestic_transaction_accounts=(), export_transaction_accounts=(),
        import_transaction_accounts=(), factors=("LAB", "CAP"),
        labor_factors=("LAB",), land_factors=(), capital_factors=("CAP",),
        institutions=("HH", "GOV", "ROW"),
        domestic_institutions=("HH", "GOV"),
        domestic_nongovernment_institutions=("HH",),
        enterprises=(), households=("HH",),
    )
    sam_values = _frozen({
        ("A", "C"): 90.0, ("A", "CEXP"): 10.0,
        ("C", "A"): 20.0, ("LAB", "A"): 40.0, ("CAP", "A"): 40.0,
        ("C", "HH"): 55.0, ("CIMP", "HH"): 5.0, ("S-I", "HH"): 10.0,
        ("HH", "LAB"): 35.0, ("GOV", "LAB"): 5.0,
        ("HH", "CAP"): 35.0, ("GOV", "CAP"): 5.0,
        ("C", "GOV"): 10.0, ("S-I", "GOV"): 0.7,
        ("GOV", "TAXM"): 0.7, ("TAXM", "C"): 0.7,
        ("ROW", "C"): 7.0, ("ROW", "CIMP"): 15.0,
        ("C", "ROW"): 10.0, ("CEXP", "ROW"): 10.0,
        ("S-I", "ROW"): 2.0, ("C", "S-I"): 2.7,
        ("CIMP", "S-I"): 10.0,
    })
    sam = IfpriSam(
        table_name="SYNTHETIC_SAM", accounts=accounts, values=sam_values, scale=1.0
    )
    elasticities = IfpriElasticities(
        ...
        market_expenditure=_frozen({
            ("C", "HH"): 1.0, ("CIMP", "HH"): 1.0, ("CEXP", "HH"): 1.0,
        }),
