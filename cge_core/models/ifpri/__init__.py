...
The package root exposes the practitioner façade and the advanced implementation
APIs used for replication, custom closures, validation, and research workflows.
"""
...
__all__ = [
    "IFPRICGE", "IFPRIEquilibrium", "IFPRIScenario", "IFPRIResult",
